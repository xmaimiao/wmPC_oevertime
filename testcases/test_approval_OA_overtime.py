...
class Test_Approval_OA_overtime:
    ...
    # A申请加班
    # @pytest.mark.skip
    @pytest.mark.dependency(name="test_overtime_application")
    ...
    # B提醒补充资料
    @pytest.mark.dependency(depends=["test_overtime_application"])
    @pytest.mark.dependency(name="test_reminder_of_supplement_B")
    ...
    def test_reminder_of_supplement_B(self, data):
        ...
        result = self.main. \
            goto_login(). \
            username(data["username"]).password(self._setup_datas["password"]).save(). \
            goto_OA_approval().goto_Overtime_approvals().goto_pending_for_approval_OA_Overtime().\
            goto_details_of_overtimeSn_OA_Overtime(self.db["overtimeSn"]).reminder_of_supplement_OA_Overtime().\
            close_details_OA_Overtime().goto_details_of_overtimeSn_OA_Overtime(self.db["overtimeSn"]).\
    ...
    # B审批通过
    @pytest.mark.dependency(depends=["test_overtime_application"])
    @pytest.mark.dependency(name="test_the_overtimeSn_for_approved")
    ...
    def test_the_overtimeSn_for_approved(self,data):
        ...
        result = self.main. \
            ...
            username(data["username"]).password(self._setup_datas["password"]).save(). \
            goto_OA_approval().goto_Overtime_approvals().goto_pending_for_approval_OA_Overtime(). \
            goto_details_of_overtimeSn_OA_Overtime(self.db["overtimeSn"]).agree_overtime_work_agreement().\
            approved_OA_Overtime().goto_approved_OA_Overtime().get_the_status_of_overtimeSn(self.db["overtimeSn"])
        assert result == data["expect"]

    # C提醒补充资料
    @pytest.mark.dependency(depends=["test_the_overtimeSn_for_approved"])
    ...
    # C审批不通过
    @pytest.mark.dependency(depends=["test_the_overtimeSn_for_approved"])
    @pytest.mark.dependency(name="test_the_overtimeSn_for_not_approved")
    ...
    def test_the_overtimeSn_for_not_approved(self,data):
        ...
        result = self.main. \
            ...
            username(data["username"]).password(self._setup_datas["password"]).save(). \
            goto_OA_approval().goto_Overtime_approvals().goto_pending_for_approval_OA_Overtime(). \
            goto_details_of_overtimeSn_OA_Overtime(self.db["overtimeSn"]).\
            not_approved_OA_Overtime().goto_approved_OA_Overtime().get_the_status_of_overtimeSn(self.db["overtimeSn"])
        assert result == data["expect"]

    # A查看申请状态
    @pytest.mark.dependency(depends=["test_the_overtimeSn_for_not_approved"])
    ...
    @pytest.mark.dependency(depends=["test_reminder_of_supplement_B"])
